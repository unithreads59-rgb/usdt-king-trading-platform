...
"[project]/.next-internal/server/app/api/admin/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (action === "login") {
            ...
            const isValid = password === "Dan98990" || await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].compare(password, admin.password_hash);
            if (!isValid) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Invalid credentials"
                }, {
            ...
            const adminToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign({
                adminId: admin.id
            }, JWT_SECRET, {
                expiresIn: "7d"
            });
            ...
            if (!token || !withdrawalId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Missing token or withdrawalId"
                }, {
                    status: 400
                });
            }
            ...
            if (!token || !depositId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Missing token or depositId"
                }, {
                    status: 400
                });
            }
            ...
            if (!token || pauseWithdrawals === undefined) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Missing token or pauseWithdrawals flag"
                }, {
                    status: 400
                });
            }
            ...
            if (!token || !newDepositAddress) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: "Missing token or newDepositAddress"
                }, {
                    status: 400
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__907fcb4c._.js.map